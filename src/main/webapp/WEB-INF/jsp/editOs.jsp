...
<div class="container theme-showcase" role="main">
    ...
    <div class="jumbotron">
        <h2>Update Order Request ID:   ${os.id}</h2>
        </br>
        </br>
        </br>

        <form  action="/admin/editOs" name="myForm" method="POST">
            <table>
                ...
                <tr>
                    <td>Cost</td>
                    <td><input type="text" name="value"   value="${os.equipment.costValue}" onKeyPress="return(MascaraMoeda(this,'.',',',event))" /></td>
                </tr>
                <tr>
